...
<form name="form1" method="post" action="order_insert.php" id="formID">
  <table width="353" height="315" border="0" align="left">
    <tr>
      <td width="138">Customer  </td>
      <td width="205"><select name="cust_id" id="cust_id" class="validate[] form-control">
    ...
    <tr>
     <td height="41">Order Date </td>
      <td><input name="order_date" type="text" id="order_date" value="<?php echo date('Y-m-d'); ?>" readonly="" class="form-control"></td>
