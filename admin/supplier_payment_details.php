...
<form name="form1" method="post" action="supplier_payment_insert.php" id="formID">
  <table width="1003" height="298" border="0" align="center" bgcolor="#FFFFFF" class="style1">
    <tr>
      ...
      <td>&nbsp;</td>
      <tr>
<td height="48">Payment Date </td>
   <td><input name="Payment_date" type="date" id="sup_pay_date" class="validate[required,custom[date]] form-control">  </td>
    </tr>
      </span></td>
    </tr>
	...
	?>
  <?php
  $sql4="select * from supplier_details where supplier_id='$s_id'";
  $res4=mysqli_query($conn,$sql4);
  $row4=mysqli_fetch_array($res4);
  $row5="update supplier_details set sup_bal='$bal' where supplier_id='$s_id'";
  $res5=mysqli_query($conn,$row5);
  ?>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td><input name="s_pamt" type="text" id="s_pamt" class="validate[required,custom[onlyFloat]] form-control"></td>
