...
<?php
	...
	$sql="select * from order_details od,customer_details cd,product_details pd where od.cust_id=cd.cust_id and od.pro_id=pd.product_id ";
    ...
    <tr>
      ...
      <td><?php echo $row['order_date'];?></td>
	       <td><a href="order_confirm.php?order_id=<?php echo $row['order_id']; ?>" onClick="return confirm('Are you sure to Order Confirm');">Order Confirm</a></td>
